      ...
      <h2 id="user-management-page-heading" data-cy="UserManagementHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon={faSync} spin={loading} /> リストの更新
          </Button>
          <Link to="new" className="btn btn-primary jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon={faPlus} /> 新しいユーザーの作成
          </Link>
        </div>
      </h2>
        ...
        <thead>
          <tr>
            ...
            <th className="hand" onClick={sort('login')}>
              ログイン <FontAwesomeIcon icon={getSortIconByFieldName('login')} />
            </th>
            <th className="hand" onClick={sort('email')}>
              メールアドレス <FontAwesomeIcon icon={getSortIconByFieldName('email')} />
            </th>
            <th />
            <th>プロファイル</th>
            <th className="hand" onClick={sort('createdDate')}>
              作成日 <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
            </th>
            <th className="hand" onClick={sort('lastModifiedBy')}>
              更新者 <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedBy')} />
            </th>
            <th id="modified-date-sort" className="hand" onClick={sort('lastModifiedDate')}>
              更新日 <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedDate')} />
            </th>
            <th />
          </tr>
        </thead>
              ...
              <td className="text-end">
                <div className="btn-group flex-btn-group-container">
                  <Button as={Link as any} to={user.login} variant="info" size="sm" data-cy="entityDetailsButton">
                    <FontAwesomeIcon icon={faEye} /> <span className="d-none d-md-inline">表示</span>
                  </Button>
                  <Button as={Link as any} to={`${user.login}/edit`} variant="primary" size="sm" data-cy="entityEditButton">
                    <FontAwesomeIcon icon={faPencilAlt} /> <span className="d-none d-md-inline">編集</span>
                  </Button>
                  <Button
                    as={Link as any}
                  ...
                  >
                    <FontAwesomeIcon icon={faTrash} /> <span className="d-none d-md-inline">削除</span>
                  </Button>
                </div>
              </td>
            </tr>
