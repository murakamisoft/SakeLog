...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './alcohol.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALCOHOL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ALCOHOL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ALCOHOL actions', async () => {
      const arg = { id: 10983 };
    ...
    it('dispatches UPDATE_ALCOHOL actions', async () => {
      const arg = { id: 10983 };
    ...
    it('dispatches PARTIAL_UPDATE_ALCOHOL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ALCOHOL actions', async () => {
      const arg = 42666;
