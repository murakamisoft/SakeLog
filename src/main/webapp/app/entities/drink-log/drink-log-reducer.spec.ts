...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './drink-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRINKLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRINKLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRINKLOG actions', async () => {
      const arg = { id: 18273 };
    ...
    it('dispatches UPDATE_DRINKLOG actions', async () => {
      const arg = { id: 18273 };
    ...
    it('dispatches PARTIAL_UPDATE_DRINKLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRINKLOG actions', async () => {
      const arg = 42666;
